if OBJECT_ID(N'Proc_QueryCPWestUnionSucceedTransLogReport_ByCPDate', N'P') is not null
begin
	drop procedure Proc_QueryCPWestUnionSucceedTransLogReport_ByCPDate;
end
go


Create Procedure Proc_QueryCPWestUnionSucceedTransLogReport_ByCPDate
...
begin 
      raiserror(N'Input params cannot be empty in Proc_QueryCPWestUnionSucceedTransLogReport_ByCPDate',16,1);
end
