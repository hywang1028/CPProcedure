if OBJECT_ID(N'Proc_QueryCPWestUnionAllTransLogReport', N'P') is not null
begin
	drop procedure Proc_QueryCPWestUnionAllTransLogReport;
end
go


Create Procedure Proc_QueryCPWestUnionAllTransLogReport
...
begin 
      raiserror(N'Input params cannot be empty in Proc_QueryCPWestUnionAllTransLogReport',16,1);
end
