if OBJECT_ID(N'Proc_QuerySalesChannelChart', N'P') is not null
begin
	drop procedure Proc_QuerySalesChannelChart;
end
go

create procedure Proc_QuerySalesChannelChart
...
begin
	raiserror(N'Input params cannot be empty in Proc_QuerySalesChannelChart', 16, 1);
end
