if OBJECT_ID(N'Proc_QueryKeyMerchantSucceedRatioReport', N'P') is not null
begin
	drop procedure Proc_QueryKeyMerchantSucceedRatioReport;
end
go

create procedure Proc_QueryKeyMerchantSucceedRatioReport
